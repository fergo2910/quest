...
Selector labels
*/}}
{{- define "quest.selectorLabels" -}}
app.kubernetes.io/name: {{ include "quest.name" . }}
...
{{- default (include "quest.fullname" .) .Values.serviceAccount.name }}
{{- else }}
